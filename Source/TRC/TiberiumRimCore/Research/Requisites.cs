...
public class Requisites
{
    ...
    public string MissingString()
    {
        ...
        //Research
        string vanResearch = research.Where(res => !res.IsFinished)
        ...
        //TResearch
        string tibResearch = tiberiumResearch.Where(res => !res.IsFinished)
            .Aggregate("", (current, res) => current + ("\n- " + res.LabelCap));
        ...
        //TResearchTask
        string tasks = tiberiumResearchTasks.Where(task => !task.IsFinished)
        ...
        //Events
        string eventsString = events.Where(@event => !@event.IsFinished)
