...
public class TResearchTaskDef : Def
{
    ...
    [Unsaved()] private List<ThingDef> unlocksThings = new List<ThingDef>();
    ...
    {
        get { return workerInt ??= (ResearchWorker)System.Activator.CreateInstance(researchWorker); }
    }
            ...
            if (mainTargets == null)
            {
                ...
                mainTargets =
                    DefDatabase<ThingDef>.AllDefsListForReading.FindAll(
                        t => t.thingClass == TargetProperties.targetType);
            }
    ...
    public virtual float ProgressReal => creationTasks != null
        ? TRUtils.ResearchCreationTable().TaskCompletion(this)
